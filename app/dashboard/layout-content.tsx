...
export default function DashboardLayoutContent({
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-100 dark:bg-neutral-800">
      ...
      <main className="flex-1 p-4 dark:text-white overflow-y-auto bg-white dark:bg-neutral-900 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 ml-2 mt-2 mb-2 mr-2">
        {children}
        <Toaster />
      </main>
    </div>
